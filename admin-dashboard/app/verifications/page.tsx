...
export default function VerificationsPage() {
    ...
    return (
        ...
        <div className="layout-container animate-fade-in">
            ...
            <div className="flex gap-6 mb-8 border-b border-border-brand pb-1">
                ...
                {['pending', 'approved', 'rejected', 'all'].map((tab) => (
                    ...
                    <button
                        ...
                        className={`px-6 py-3 rounded-t-lg font-semibold text-sm uppercase tracking-wide transition-all border-b-2 flex items-center gap-[4.25px] ${filter === tab
                                ...
                                bouncers.map((bouncer) => (
                                    ...
                                    <tr key={bouncer.id} className="group">
                                        ...
                                        <td>
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                {bouncer.profilePhoto ? (
                                                    ...
                                                    <div className="w-8 h-8 rounded-full bg-surface-elevated flex items-center justify-center ring-2 ring-border">

                                                        <span className="text-text-tertiary font-bold text-[10px]">
                                        ...
                                        <td>
                                            ...
                                            <span className="inline-flex items-center h-[24px] mx-2 text-[12px] font-semibold rounded-full bg-surface-elevated border border-border-brand text-text-secondary shadow-sm" style={{ paddingLeft: '8px', paddingRight: '8px' }}>
                                        ...
                                        <td>
                                            ...
                                            <span className={`inline-flex items-center h-[22px] mx-2 text-[10px] font-bold uppercase tracking-wider border rounded-full shadow-sm ${getStatusColor(bouncer.verificationStatus)}`} style={{ paddingLeft: '6px', paddingRight: '6px' }}>
                                        ...
                                        <td className="text-text-tertiary text-xs" style={{ paddingLeft: '27px' }}>
                                        ...
                                        <td className="text-right" style={{ paddingLeft: '27px' }}>

                                            <div className="flex items-center justify-start gap-2 mr-16">
                                                ...
                                                <button
                                                    ...
                                                    className="btn-base btn-secondary hover:text-primary hover:border-primary text-[10px] ml-2 font-bold"

                                                    style={{ paddingTop: '2px', paddingBottom: '2px', paddingLeft: '8px', paddingRight: '8px', borderRadius: '9999px' }}
            ...
            {selectedBouncer && (
                ...
                <>
                    ...
                    <div
                        ...
                        className="fixed top-0 bottom-0 left-1/2 -translate-x-1/2 w-[90vw] h-screen max-h-[70vh] max-w-[1200px] bg-surface rounded-2xl shadow-2xl flex flex-col z-50 overflow-hidden "
                    ...
                    >
                        ...
                        <div className="flex-none flex items-center justify-between px-10 py-7 border-b border-border-brand bg-surface-elevated z-30 shadow-sm">

                            <div className="flex items-center gap-4">

                                <div className="relative group ml- w-12 h-12">
                                    ...
                                    {selectedBouncer.profilePhoto ? (
                                        ...
                                        <img
                                            ...
                                            className="relative w-12 h-12 rounded-full object-cover border-2 border-primary shadow-2xl z-10"
                                    ...
                                    <div className={`absolute bottom-0 right-0 w-3.5 h-3.5 rounded-full border-2 border-surface-elevated z-20 shadow-md ${selectedBouncer.isAvailable ? 'bg-green-500' : 'bg-gray-500'}`}></div>
                                ...
                                {selectedBouncer.verificationStatus === 'PENDING' && (
                                    ...
                                    <>
                                        ...
                                        <button
                                            ...
                                            style={{ padding: '4px 10px', fontSize: '9px', minHeight: '20px', whiteSpace: 'nowrap', display: 'flex', alignItems: 'center', justifyContent: 'center', width: 'auto', fontWeight: 'bold', textTransform: 'uppercase', letterSpacing: '0.05em' }}
                        ...
                        <div className="flex-1 h-auto px-6 pt-3 pb-6 space-y-3 bg-gradient-to-b from-surface via-surface to-surface-elevated overflow-y-auto">

                            {/* Stats Grid */}

                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 my-4" style={{ marginTop: '1rem', marginBottom: '1rem' }}>

                                <div className="bg-surface-elevated p-1 rounded-2xl border border-border-brand shadow-sm hover:border-primary-glow transition-all group flex flex-col items-center justify-center gap-0">

                                    <div className="flex items-center gap-1.5">

                                        <div className="text-[10px] font-black tracking-[0.05em] text-text-tertiary uppercase group-hover:text-primary transition-colors">Registration</div>

                                        <svg className="w-4 h-4 text-text-primary opacity-40" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>

                                    </div>

                                    <div className="text-xl font-extrabold text-text-primary uppercase tracking-tight px-2">{selectedBouncer.registrationType}</div>
                                ...
                                <div className="bg-surface-elevated p-1 rounded-2xl border border-border-brand shadow-sm hover:border-primary-glow transition-all group flex flex-col items-center justify-center gap-0">
                                    ...
                                    <div className="flex items-center gap-1.5">
                                        ...
                                        <div className="text-[10px] font-black tracking-[0.05em] text-text-tertiary uppercase group-hover:text-primary transition-colors">Contact</div>

                                        <svg className="w-4 h-4 text-text-primary opacity-40" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h2.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                                ...
                                <div className="bg-surface-elevated p-1 rounded-2xl border border-border-brand shadow-sm hover:border-primary-glow transition-all group flex flex-col items-center justify-center gap-0">
                                    ...
                                    <div className="flex items-center gap-1.5">
                                        ...
                                        <div className="text-[10px] font-black tracking-[0.05em] text-text-tertiary uppercase group-hover:text-primary transition-colors">Personal</div>

                                        <svg className="w-4 h-4 text-text-primary opacity-40" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>
                                ...
                                <div className="bg-surface-elevated p-1 rounded-2xl border border-border-brand shadow-sm hover:border-primary-glow transition-all group flex flex-col items-center justify-center gap-2 text-center">

                                    <div className="flex items-center gap-1.5">

                                        <div className="text-[10px] font-black tracking-[0.05em] text-text-tertiary uppercase group-hover:text-primary transition-colors">Status</div>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                ...
                                <div className="lg:col-span-1 space-y-6">
                                    ...
                                    <div className="bg-surface-elevated p-5 rounded-2xl border border-border-brand shadow-xl relative overflow-hidden" style={{ paddingLeft: '1.5rem' }}>

                                        <div className="absolute top-0 left-0 w-1 h-full bg-primary opacity-50"></div>

                                        <h3 className="text-xs font-black text-text-primary uppercase tracking-[0.3em] mb-6 flex items-center gap-3" style={{ marginTop: '0.4rem' }}>
                                ...
                                <div className="lg:col-span-1 space-y-6">
                                    ...
                                    <div className="bg-surface-elevated p-5 rounded-2xl border border-border-brand shadow-2xl" style={{ marginTop: '0.5rem' }}>

                                        <h3 className="text-xs font-black text-text-primary uppercase tracking-[0.2em] mb-5 flex justify-between items-end border-b border-border-brand pb-3" style={{ marginTop: '0px', paddingTop: '0px' }}>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="bg-black/80 rounded-xl border border-border-brand overflow-hidden shadow-lg group hover:border-primary transition-all">
                                                ...
                                                <div className="p-3 flex items-center justify-center bg-[#080808] max-h-[400px]">
                        ...
                        {selectedBouncer.verificationStatus === 'PENDING' && (
                            ...
                            <div className="flex-none relative bg-surface-elevated border-t border-border-brand flex items-center justify-between px-10 py-4 z-30" style={{ paddingTop: '4px', paddingBottom: '4px', paddingLeft: '8px', paddingRight: '8px' }}>

                                <button

                                    onClick={() => setSelectedBouncer(null)}

                                    className="px-3 py-2 rounded-xl bg-surface border border-border-brand text-text-secondary hover:text-text-primary hover:border-primary transition-all font-semibold"

                                    style={{ padding: '4px 12px', fontSize: '11px', lineHeight: '1rem' }}
                                ...
                                <div className="flex items-center justify-center" style={{ gap: '4px' }}>
                                    ...
                                    <>
                                        ...
                                        <button
                                            ...
                                            className="px-3 py-1.5 rounded-full text-white font-bold text-[10px] uppercase tracking-[0.05em] hover:brightness-110 transition-all shadow-md transform hover:-translate-y-0.5 active:translate-y-0 bg-error"

                                            style={{ padding: '4px 10px', fontSize: '9px', minHeight: '20px', whiteSpace: 'nowrap', display: 'flex', alignItems: 'center', justifyContent: 'center', width: 'auto', fontWeight: 'bold', textTransform: 'uppercase' }}
                                        ...
                                        <button
                                            ...
                                            className="px-3 py-1.5 rounded-full text-white font-bold text-[10px] uppercase tracking-[0.05em] hover:brightness-110 transition-all shadow-md flex items-center gap-2 transform hover:-translate-y-0.5 active:translate-y-0 bg-success"
                        ...
                        {selectedBouncer.verificationStatus !== 'PENDING' && (
                            ...
                            <div className="relative mt-auto px-6 py-4 bg-surface-elevated border-t border-border-brand flex items-center justify-center z-20">
