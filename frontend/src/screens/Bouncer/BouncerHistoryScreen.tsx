...
export default function BouncerHistoryScreen() {
    ...
    const renderHistoryItem = React.useCallback(({ item, isUpcoming = false }: { item: BookingHistory, isUpcoming?: boolean }) => {
        return <HistoryCardBouncer item={item} isUpcoming={isUpcoming} navigation={navigation} />;
    }, [navigation]);
